<div id="fullscreen-container" class="hidden fixed inset-0 bg-black flex items-center justify-center z-50">
    <div class="relative flex flex-col w-full h-full">
        <div class="flex justify-center items-center h-[80%] md:h-[90%]">
            <img id="fullscreen-image" class="max-h-full object-contain">
        </div>
        <div id="image-description" class="w-full bg-white text-black py-3 px-6 absolute bottom-0 left-0 text-lg flex items-center">
